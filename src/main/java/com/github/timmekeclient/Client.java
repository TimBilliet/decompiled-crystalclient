...
import com.github.timmekeclient.account.AltManager;
import com.github.timmekeclient.command.*;
import com.github.timmekeclient.cosmetic.CosmeticManager;
import com.github.timmekeclient.cosmetic.type.cloak.LayerCloak;
import com.github.timmekeclient.cosmetic.type.wings.LayerWings;
import com.github.timmekeclient.duck.NetworkPlayerInfoExt;
...
import com.github.timmekeclient.handler.*;
import com.github.timmekeclient.mixin.accessor.net.minecraft.client.MixinMinecraft;
import com.github.timmekeclient.mixin.accessor.net.minecraft.client.entity.MixinAbstractClientPlayer;
import com.github.timmekeclient.mixin.accessor.net.minecraft.client.renderer.entity.MixinRenderManager;
import com.github.timmekeclient.mixin.accessor.net.minecraft.client.renderer.entity.MixinRendererLivingEntity;
import com.github.timmekeclient.network.Packet;
import com.github.timmekeclient.network.WebClient;
import com.github.timmekeclient.network.plugin.ChannelRegistry;
import com.github.timmekeclient.network.plugin.impl.ClientApiHandler;
import com.github.timmekeclient.network.plugin.impl.HandshakeHandler;
import com.github.timmekeclient.network.plugin.impl.ModuleApiHandler;
import com.github.timmekeclient.network.plugin.impl.WorldEditCuiHandler;
import com.github.timmekeclient.network.socket.NetHandlerClient;
import com.github.timmekeclient.util.ClientTextureManager;
import com.github.timmekeclient.util.Log4jPatch;
import com.github.timmekeclient.util.enums.ChatColor;
import com.github.timmekeclient.util.enums.MinecraftVersion;
...
public class Client {
    ...
    private static final boolean OBFUSCATED = !isClassLoaded(String.format("%s.%s.%s.%s", "com", "github", "timmekeclient", "Client"));
    ...
    public Client() {
        ...
        Reference.LOGGER.info("{} version {} is being initialized.", "Timmeke_ Client", "1.3.2");
        ...
        Reference.LOGGER.info("{} version {} has been initialized.", "Timmeke_ Client", "1.3.2");
...
//        }
    ...
    public static String getPrefix() {
        return ChatColor.translate(String.format("&8<&b&l%s&8>&r", "Timmeke_ Client"));
    }
