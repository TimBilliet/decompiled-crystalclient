...
public class Config {
    ...
    public boolean isConfigAnnotation(Annotation a) {
        return (a instanceof Toggle || a instanceof Colour || a instanceof Selector || a instanceof Property || a instanceof Slider || a instanceof Position || a instanceof Keybind || a instanceof DropdownMenu || a instanceof PageBreak);
    }
