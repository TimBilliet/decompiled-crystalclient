...
import com.github.timmekeclient.cosmetic.CosmeticCache;
import com.github.timmekeclient.cosmetic.CosmeticManager;
import com.github.timmekeclient.cosmetic.CosmeticPlayer;
import com.github.timmekeclient.cosmetic.CosmeticType;
import com.github.timmekeclient.cosmetic.base.Cosmetic;
import com.github.timmekeclient.cosmetic.type.Emoticon;
import com.github.timmekeclient.cosmetic.type.cloak.AnimatedCloak;
import com.github.timmekeclient.cosmetic.type.cloak.Cloak;
import com.github.timmekeclient.cosmetic.type.wings.Wings;
...
import com.github.timmekeclient.gui.screens.ScreenCosmetics;
import com.github.timmekeclient.util.RenderUtils;
import com.github.timmekeclient.util.objects.resources.cosmetic.ICosmeticTexture;
...
public class ThumbnailCommand extends AbstractCommand {
    ...
    public void onRenderOverlay(RenderOverlayEvent.All event) {
        ...
        if (!cosmetics.isEmpty()) {
            ...
            if (next instanceof Wings || next instanceof Cloak || next instanceof AnimatedCloak) {
                if (next.isAnimated()) {
            ...
            } else if (next instanceof Emoticon) {
