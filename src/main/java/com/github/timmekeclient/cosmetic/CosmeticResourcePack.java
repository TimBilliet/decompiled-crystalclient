...
public class CosmeticResourcePack extends FolderResourcePack {
    private static final Set<String> DEFAULT_RESOURCE_DOMAINS = (Set<String>) ImmutableSet.of("timmekeclient");
    ...
    public String getPackName() {
        return ChatColor.translate("&b&lTimmeke_ Client &7| &fCosmetics");
    }
