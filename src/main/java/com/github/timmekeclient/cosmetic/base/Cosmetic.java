package com.github.timmekeclient.cosmetic.base;
...
public class Cosmetic {
    ...
    public Cosmetic(@Nullable CosmeticEntry entry) {
        if (entry == null) {
            ...
            this.location = (entry.getResourceLocation() == null) ? new ResourceLocation("timmekeclient", "cosmetics/" + this.type.name().toLowerCase() + "/" + this.name) : entry.getResourceLocation();
        }
    }
