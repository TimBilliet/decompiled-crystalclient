package com.github.timmekeclient.ext;
...
import com.github.timmekeclient.mixin.accessor.net.minecraft.client.gui.MixinGuiIngame;
import com.github.timmekeclient.mixin.accessor.net.minecraftforge.client.MixinGuiIngameForge;
...
public class GuiIngameTimmeke extends GuiIngameForge {
    private ScaledResolution res = null;

    private FontRenderer fontrenderer = null;

    private GuiOverlayDebugTimmeke debugOverlay;

    public GuiIngameTimmeke(Minecraft mc) {
        super(mc);
        this.debugOverlay = new GuiOverlayDebugTimmeke(mc);
    }
    ...
    private static class GuiOverlayDebugTimmeke extends GuiOverlayDebug {
        private GuiOverlayDebugTimmeke(Minecraft mc) {
            super(mc);
        }
