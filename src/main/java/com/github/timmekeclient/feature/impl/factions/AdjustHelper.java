...
import com.github.timmekeclient.gui.screens.ScreenAdjHelper;
import com.github.timmekeclient.network.Packet;
import com.github.timmekeclient.network.socket.client.group.PacketAdjHelper;
...
import com.github.timmekeclient.util.objects.Adjust;
...
public class AdjustHelper extends Module implements IRegistrable {
    ...
    public KeyBinding guiBind = new KeyBinding("timmekeclient.key.open_adjust_helper_gui", 0, "Timmeke_ Client - Adjust Helper");

    @Keybind(label = "Next Adjust")
    public KeyBinding nextAdjust = new KeyBinding("timmekeclient.key.next_adjust", 0, "Timmeke_ Client - Adjust Helper");

    @Keybind(label = "Send Coordinates Bind")
    public KeyBinding coordinatesBind = new KeyBinding("timmekeclient.key.shout_current_adjust", 0, "Timmeke_ Client - Adjust Helper");
