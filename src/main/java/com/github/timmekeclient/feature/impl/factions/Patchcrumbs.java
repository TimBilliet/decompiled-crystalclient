...
import com.github.timmekeclient.cache.SandCache;
import com.github.timmekeclient.duck.EntityExt;
...
import com.github.timmekeclient.network.socket.client.group.PacketPatchcrumbUpdate;
...
import com.github.timmekeclient.util.objects.crumbs.CrumbEntity;
import com.github.timmekeclient.util.objects.crumbs.Patchcrumb;
...
public class Patchcrumbs extends Module implements IRegistrable {
    ...
    public KeyBinding shoutLocation = new KeyBinding("timmekeclient.key.shout_patchcrumb_location", 0, "Timmeke_ Client - Crumbs");
