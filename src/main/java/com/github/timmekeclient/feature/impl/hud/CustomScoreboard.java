...
public class CustomScoreboard extends HudModule implements IRegistrable {
    ...
    private void setDummyScoreboard() {
        String teamName = ChatColor.translate('&', "&d&lTimmeke_ Client");
        List<String> scoresToRegister = Arrays.asList("&7&o  :)", "&7 ", "  &f&l* &dDummy: &fScoreboard7", "  &f&l* &dDummy: &fScoreboard6", "  &f&l* &dDummy: &fScoreboard5", "  &f&l* &dDummy: &fScoreboard4", "&f&lAnother Section", "&7 ", "  &f&l* &dDummy: &fScoreboard3", "  &f&l* &dDummy: &fScoreboard2",
