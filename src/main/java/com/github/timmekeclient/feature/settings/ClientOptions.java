...
import com.github.timmekeclient.gui.screens.ScreenSettings;
...
import com.github.timmekeclient.util.objects.EmoteWheel;
...
public class ClientOptions extends Module implements IRegistrable {
    ...
    public void configPostInit() {
        ...
        if (this.dontOverrideDisplayTitle) {
            ...
            Display.setTitle(String.format("Minecraft %s | %s (v%s)", Client.getMinecraftVersion().getVersionString(),"Timmeke_ Client", "1.3.2"));
        }
    }
