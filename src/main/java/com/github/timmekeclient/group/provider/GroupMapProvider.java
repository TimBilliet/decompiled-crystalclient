package com.github.timmekeclient.group.provider;

import com.github.timmekeclient.Client;
import com.github.timmekeclient.cache.SkinCache;
...
import com.github.timmekeclient.util.objects.resources.CachedSkin;
...
public class GroupMapProvider implements IMwDataProvider {
    ...
    public void onDraw(MapView mapview, MapMode mapmode) {
        if (GroupManager.getSelectedGroup() != null && (GroupOptions.getInstance()).showMembersOnMap && (!(GroupOptions.getInstance()).onlyShowOnBigMap || this.mc.currentScreen instanceof ScreenMapWriter))
