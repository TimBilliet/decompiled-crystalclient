...
import com.github.timmekeclient.gui.buttons.SimpleColorPicker;
...
import com.github.timmekeclient.network.socket.client.group.PacketClearChunkHighlights;
import com.github.timmekeclient.network.socket.client.group.PacketHighlightChunk;
import com.github.timmekeclient.network.socket.client.group.PacketRemoveChunkHighlight;
...
public class ScreenMapWriter extends Screen {
    ...
    private void renderPane() {
        ...
        int fontWidth = Fonts.NUNITO_SEMI_BOLD_24.getStringWidth("TIMMEKE_");
        ...
        y += fontSize / 2;
        Fonts.NUNITO_SEMI_BOLD_24.drawCenteredString("TIMMEKE_", x, y, -1);
        y += fontSize;
