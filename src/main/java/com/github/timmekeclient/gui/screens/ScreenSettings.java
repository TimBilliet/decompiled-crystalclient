...
import com.github.timmekeclient.gui.ButtonHoverOverlay;
import com.github.timmekeclient.gui.Pane;
import com.github.timmekeclient.gui.buttons.Divider;
import com.github.timmekeclient.gui.buttons.ScrollBarButton;
...
public class ScreenSettings extends ScreenBase {
    ...
    public void onButtonInteract(Button button, int mouseX, int mouseY, int mouseButton) {
        ...
        if (!(button instanceof ScrollBarButton))
            ensureOptionVisibility();
    }
                    ...
                    for (Annotation annotation : field.getDeclaredAnnotations()) {
                        if (Config.getInstance().isConfigAnnotation(annotation) && !Config.getInstance().isAnnotationInvalid(annotation, this.module)) {
                            ...
                            if (annotation instanceof Toggle) {
                                ...
                                if (this.y != this.content.y + 5 || !(this.module instanceof HudModule)) {
                                    this.y += 6;
