package com.github.timmekeclient.gui.screens.override;
...
import com.github.timmekeclient.gui.ScreenPanorama;
import com.github.timmekeclient.gui.buttons.AccountButton;
import com.github.timmekeclient.gui.buttons.MenuButton;
import com.github.timmekeclient.gui.buttons.ResourceButton;
import com.github.timmekeclient.gui.ease.Animation;
import com.github.timmekeclient.gui.ease.Easing;
...
public class ScreenMainMenu extends ScreenPanorama implements GuiYesNoCallback {
    ...
    private static final String CC_VERSION = String.format("%s v%s", "Timmeke_ Client", "1.7.0");
    ...
    public void draw(int mouseX, int mouseY, float partialTicks) {
        ...
        fr.drawString("TIMMEKE_ CLIENT", width / 2 - fr.getStringWidth("TIMMEKE_ CLIENT") / 2, y, -1);
        y -= size;
