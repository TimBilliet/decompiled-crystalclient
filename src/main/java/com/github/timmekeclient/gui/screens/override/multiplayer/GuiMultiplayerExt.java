package com.github.timmekeclient.gui.screens.override.multiplayer;

import com.github.timmekeclient.network.socket.shared.PacketServerList;
import com.github.timmekeclient.util.objects.partners.PartneredServerData;
...
public class GuiMultiplayerExt extends GuiScreen {
    ...
    public void selectServer(int index) {
        ...
        if (guilistextended$iguilistentry != null) {
            ...
            if (guilistextended$iguilistentry instanceof ServerListEntryNormalExt) {
                boolean flag = !(((ServerListEntryNormalExt) guilistextended$iguilistentry).getServerData() instanceof PartneredServerData);
    ...
    public boolean canMoveUp(ServerListEntryNormalExt p_175392_1_, int p_175392_2_) {
        if (p_175392_1_.getServerData() instanceof PartneredServerData)
            return false;
    ...
    public boolean canMoveDown(ServerListEntryNormalExt p_175394_1_, int p_175394_2_) {
        if (p_175394_1_.getServerData() instanceof PartneredServerData)
            return false;
    ...
    public void moveEntryUp(ServerListEntryNormalExt p_175391_1_, int p_175391_2_, boolean p_175391_3_) {
        if (p_175391_1_.getServerData() instanceof PartneredServerData)
            return;
    ...
    public void moveEntryDown(ServerListEntryNormalExt p_175393_1_, int p_175393_2_, boolean p_175393_3_) {
        if (p_175393_1_.getServerData() instanceof PartneredServerData)
            return;
