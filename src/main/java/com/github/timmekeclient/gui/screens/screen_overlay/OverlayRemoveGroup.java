...
import com.github.timmekeclient.network.socket.client.group.PacketDeleteGroup;
import com.github.timmekeclient.util.objects.FadingColor;
import org.apache.commons.lang3.text.WordUtils;

public class OverlayRemoveGroup extends ScreenOverlay {
    private static final FontRenderer fr = Fonts.NUNITO_REGULAR_16;

    private final Group group;

    public OverlayRemoveGroup(Group group) {
        super(0, 0, 200, 10, "Delete group");
        this.group = group;
    }

    public void init() {
        String desc = String.format("Are you sure you wish to delete your group '%s'? This action will result in the group being permanently deleted and is irreversible.", this.group.getName());
        ...
        addButton((Button) new MenuButton(-1, this.pane.x + this.pane.width / 2 + 2, y, this.pane.width / 2 - 7, 18, "Remove Group") {
            {
                onClick = () -> {
                    PacketDeleteGroup packet = new PacketDeleteGroup();
...
/* Location:              C:\Users\Tim\AppData\Roaming\.minecraft\mods\temp\Crystal_Client-1.1.16-projectassfucker_1.jar!\co\crystaldev\client\gui\screens\screen_overlay\OverlayRemoveGroup.class
