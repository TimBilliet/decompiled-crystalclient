...
import com.github.timmekeclient.event.impl.entity.EntityAttackEvent;
import com.github.timmekeclient.event.impl.init.InitializationEvent;
import com.github.timmekeclient.event.impl.init.ModuleOptionUpdateEvent;
...
import com.github.timmekeclient.feature.impl.all.*;
import com.github.timmekeclient.feature.impl.combat.*;
import com.github.timmekeclient.feature.impl.factions.*;
import com.github.timmekeclient.feature.impl.hud.*;
import com.github.timmekeclient.feature.impl.mechanic.*;
import com.github.timmekeclient.feature.settings.ClientOptions;
import com.github.timmekeclient.gui.Screen;
import com.github.timmekeclient.gui.screens.*;
import com.github.timmekeclient.gui.screens.override.multiplayer.GuiMultiplayerExt;
import com.github.timmekeclient.gui.screens.screen_overlay.OverlayEditWaypoint;
import com.github.timmekeclient.mixin.accessor.net.minecraft.client.MixinMinecraft;
import com.github.timmekeclient.mixin.accessor.net.minecraft.client.gui.MixinGuiMultiplayer;
...
public class ModuleHandler implements IRegistrable {
    ...
    public ModuleHandler() {
        ...
        registerModule(EffectAlert.class);
        registerModule(SpotifyStats.class);
        registerModule(ClickSettings.class);
    ...
    public void onGuiClosed(GuiScreenEvent.Pre event) {
        ...
        } else if (event.oldScreen instanceof ScreenSettings || event.oldScreen instanceof ScreenWaypoints || event.oldScreen instanceof ScreenMacros) {
    ...
    public void onRenderHud(RenderOverlayEvent.All event) {
        ...
        if (this.mc.currentScreen instanceof ScreenMapWriter)
            return;
        boolean def = (this.mc.currentScreen instanceof ScreenModules || this.mc.currentScreen instanceof ScreenSettings || this.mc.currentScreen instanceof ScreenEditLocations);
        for (Module module : modules) {
