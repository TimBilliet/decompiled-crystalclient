...
import com.github.timmekeclient.gui.Overlay;
import com.github.timmekeclient.gui.overlay.OverlayEmoticonWheel;
...
public class OverlayHandler implements IRegistrable {
    ...
    private final KeyBinding emoteWheel = new KeyBinding("timmekeclient.key.emote_wheel", 34, "Timmeke_ Client");
