...
import com.github.timmekeclient.network.socket.client.group.PacketShareSchematic;
import com.github.timmekeclient.util.FileUtils;
import com.github.timmekeclient.util.MultipartUploader;
...
public class SchematicHandler {
    ...
    public void shareCurrentSchematic() {
        if (ClientProxy.currentSchematic.schematic == null)
            return;
        com.github.timmekeclient.feature.impl.factions.Schematica.getInstance().getWorkerThread().execute(() -> {
            try {
