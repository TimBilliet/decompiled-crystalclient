package com.github.timmekeclient.shader;

import com.github.timmekeclient.util.ArrayUtils;
...
public class ShaderLoader {
    ...
    public static ShaderLoader load(ShaderType type, String fileName) throws Exception {
        ...
        if (shaderLoader == null) {
            ResourceLocation resourceLocation = new ResourceLocation("timmekeclient", "shaders/program/" + fileName + type.getShaderExtension());
