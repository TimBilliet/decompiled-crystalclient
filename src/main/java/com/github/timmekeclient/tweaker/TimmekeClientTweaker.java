package com.github.timmekeclient.tweaker;
...
public class TimmekeClientTweaker implements ITweaker {
    ...
    public void injectIntoClassLoader(LaunchClassLoader classLoader) {
        ...
        Mixins.addConfiguration("mixins.timmekeclient.json");
        ...
        if (codeSource != null) {
            ...
            Logger logger = LogManager.getLogger("Timmeke_ Client CoreMod");
