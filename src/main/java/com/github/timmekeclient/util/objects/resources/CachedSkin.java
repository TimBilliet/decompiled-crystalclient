package com.github.timmekeclient.util.objects.resources;

import com.github.timmekeclient.util.ClientTextureManager;
import com.github.timmekeclient.util.task.DownloadImageTask;
...
public class CachedSkin {
    ...
    public void loadTexture() {
        if (this.resourceLocation == null) {
            this.resourceLocation = new ResourceLocation("timmekeclient", "cache_" + this.uuid.toString());
