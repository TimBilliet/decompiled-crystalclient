  ...
  public JSONObject toJson() {
    return (new JSONObject())
      ...
      .put("timestamps", (new JSONObject())
        .put("start", (this.startTimestamp == null) ? null : Long.valueOf(this.startTimestamp.toEpochSecond()))
        .put("end", (this.endTimestamp == null) ? null : Long.valueOf(this.endTimestamp.toEpochSecond())))
      .put("assets", (new JSONObject())
        .put("large_image", this.largeImageKey)
        .put("large_text", this.largeImageText)
        .put("small_image", this.smallImageKey)
        .put("small_text", this.smallImageText))
      .put("party", (this.partyId == null) ? null : (new JSONObject())
        .put("id", this.partyId)
        .put("size", (new JSONArray()).put(this.partySize).put(this.partyMax)))
      .put("secrets", (new JSONObject())
        .put("join", this.joinSecret)
        .put("spectate", this.spectateSecret)
        .put("match", this.matchSecret))
...
/* Location:              C:\Users\Tim\AppData\Roaming\.minecraft\mods\temp\Crystal_Client-1.1.16-projectassfucker_1.jar!\com\jagrosh\discordipc\entities\RichPresence.class
