...
public class JSONObject {
    ...
    public static String[] getNames(JSONObject jo) {
        ...
        if (length == 0)
            return null;
        return jo.keySet().<String>toArray(new String[length]);
    }
...
/* Location:              C:\Users\Tim\AppData\Roaming\.minecraft\mods\temp\Crystal_Client-1.1.16-projectassfucker_1.jar!\org\json\JSONObject.class
